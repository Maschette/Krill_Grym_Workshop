---
title: "Grym_workshop_test"
author: "Dale Maschette"
date: "07/01/2022"
output: html_document
---
This document contains no notes, it's whole purpose is to test that the packages you have installed, and the code will run as expected for the workshop. 

You should be able to use the Knit button above and have it render a html document without error. 
...
prRecruitPars = read.csv("./0_Setup/Recruit_pars.csv")
